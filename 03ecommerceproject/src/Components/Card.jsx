function Card({source,name,price}){
    return(
        ...
        <div class="mx-auto max-w-5xl px-5 py-24">
          <div class="mx-auto flex flex-wrap items-center lg:w-4/5">
            <img
              ...
              src={source+"&amp;ixid=MnwxMjA3fDB8MHxzZWFyY2h8Nnx8c2hvZXN8ZW58MHx8MHx8&amp;auto=format&amp;fit=crop&amp;w=800&amp;q=60"}
            />
            <div class="mt-6 w-full lg:mt-0 lg:w-1/2 lg:pl-10">
              <h2 class="text-sm font-semibold tracking-widest text-gray-500">
                Nike
              </h2>
              <h1 class="my-4 text-3xl font-semibold text-blue">{name}</h1>
              ...
              <div class="flex items-center justify-between">
                <span class="title-font text-xl font-bold text-white-900">
                  ₹{price}
                </span>
                <button
                  type="button"
